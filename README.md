# 5.2, 5.3 y 5.4 GuessTheWordViewModel :earth_africa:

## Descripcion
En este repositorio nos encontramos con la continuacion de la aplicacion trabajada en el repositorio anterior. En este caso hacemos, seguimos trabajando con la arquitectura de Android en los diferentes componentes, añadiendo la clase LiveData con la que podemos observar en un ciclo de vida.
